...
namespace CleanArchMvc.API.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        {
            var result = await Authentication.Authenticate(userInfo.Email, userInfo.Password);
        ...
        public async Task<ActionResult> CreateUser([FromBody] UserDTO userInfo)
        {
            var result = await Authentication.RegisterUser(userInfo.Email, userInfo.Password);
